      ...
      <div className="about_body">
        <div className="about_form">
          <div className="left_side">
            <div className="img">
              <img
                src={document.name === "prathamesh sudam mate" ? img : unknown}
              ...
              <ul>
                ...
                <li>
                  <a href="https://www.youtube.com/" target="blank">
                    <InstagramIcon /> Youtube
                  </a>
                </li>
                <li>
                  <a
                    href="https://www.linkedin.com/in/prathamesh-mate-6234431a9/"
                    target="blank"
                  >
                    <InstagramIcon /> Linkdin
                  </a>
                </li>
                <li>
                  <a href="https://github.com/prathameshmate" target="blank">
                    <InstagramIcon /> Github
                  </a>
                </li>
              </ul>
            </div>
